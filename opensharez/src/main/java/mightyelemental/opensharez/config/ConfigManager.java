...
public class ConfigManager {
	...
	public static boolean doesConfigExists() { return new File( CONFIG_FILE_PATH ).exists(); }
	...
	public static <T> void setSetting(String name, T value) {
		...
		for (ConfigSetting<?> conf : settings) { if (conf.getSettingName().equals( name )) { curr = (ConfigSetting<T>) conf; } }
	...
	public static void saveConfig() throws IOException {
		...
		for (ConfigSetting setting : settings) { writer.write( setting.getSaveString() + "\n" ); }
